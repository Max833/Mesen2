...
std::unordered_map<string, string> MessageManager::_enResources = {
	...
	{ "MovieMissingRom", u8"Zum Abspielen des Films fehlt ROM (%1)" },
	...
	{ "MovieSaved", u8"Film gespeichert unter: %1" },
	...
	{ "SaveStateInvalidFile", u8"Spielstand-Datei nichtkorrekt" },
	...
	{ "SaveStateLoadedFile", u8"Spielstand #%1 geladen" },
	{ "SaveStateSavedFile", u8"Spielstand %1 gespeichert" },
